  ...
  return (
    <>
      ...
      <div id="privacy">
        ...
        this Privacy Policy. This Privacy Policy has been created with the help
        of the Free Privacy Policy Generator. Interpretation and Definitions
        ...
        or other managing authority. Company (referred to as either "the
        Company", "We", "Us" or "Our" in this Agreement) refers to music player.
        ...
        browsing history on that website among its many uses. Country refers to:
        Mexico Device means any device that can access the Service such as a
        ...
        applicable. Collecting and Using Your Personal Data Types of Data
        ...
        include, but is not limited to: Usage Data Usage Data Usage Data is
        ...
        Cookies. Web Beacons. Certain sections of our Service and our emails may
        ...
        Policy or the Cookies section of our Privacy Policy. Use of Your
        Personal Data The Company may use Personal Data for the following
        purposes: To provide and maintain our Service, including to monitor the
        ...
        any other contract with Us through the Service. To contact You: To
        ...
        opted not to receive such information. To manage Your requests: To
        attend and manage Your requests to Us. For business transfers: We may
        ...
        held by Us about our Service users is among the assets transferred. For
        ...
        Providers: We may share Your personal information with Service Providers
        to monitor and analyze the use of our Service, to contact You. For
        business transfers: We may share or transfer Your personal information
        ...
        companies that We control or that are under common control with Us. With
        ...
        in the public areas with other users, such information may be viewed by
        all users and may be publicly distributed outside. With Your consent: We
        ...
        Personal Data only for as long as is necessary for the purposes set out
        ...
        Your data and other personal information. Delete Your Personal Data You
        have the right to delete or request that We assist in deleting the
        ...
        security. Children's Privacy Our Service does not address anyone under
        the age of 13. We do not knowingly collect personally identifiable
        ...
        Privacy Policy are effective when they are posted on this page. Contact
        Us If you have any questions about this Privacy Policy, You can contact
      ...
      <div id="terms">
        ...
        terms and conditions carefully before using Our Service. Interpretation
        and Definitions Interpretation The words of which the initial letter is
        ...
        they appear in singular or in plural. Definitions For the purposes of
        these Terms and Conditions: Affiliate means an entity that controls, is
        ...
        authority. Country refers to: Mexico Company (referred to as either "the
        Company", "We", "Us" or "Our" in this Agreement) refers to Music Player.
        Device means any device that can access the Service such as a computer,
        a cellphone or a digital tablet. Service refers to the Website. Terms
        ...
        has been created with the help of the Free Terms and Conditions
        ...
        Service. Website refers to Music Player, accessible from
        https://peaceful-trifle-c783ab.netlify.app/ You means the individual
        accessing or using the Service, or the company, or other legal entity on
        behalf of which such individual is accessing or using the Service, as
        ...
        obligations of all users regarding the use of the Service. Your access
        ...
        carefully before using Our Service. Links to Other Websites Our Service
        ...
        visit. Termination We may terminate or suspend Your access immediately,
        ...
        under any provision of this Terms and Your exclusive remedy for all of
        ...
        the Service. To the maximum extent permitted by applicable law, in no
        ...
        these Terms shall not effect a party's ability to exercise such right or
        require such performance at any time thereafter nor shall the waiver of
        a breach constitute a waiver of any subsequent breach. Translation
